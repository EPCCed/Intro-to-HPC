...
Having watched the above video, how would you modify it to make it more accurate? Share your ideas in the comments section!

HECToR Artist’s impression of the HECToR XT4 system © Cray Inc (image)

HECToR's compute blades HECToR’s compute blades (image)
...
In step 2.14 we asked you to look at Piz Daint, which is accelerated compared to ARCHER by the addition of Nvidia’s GPGPUs. Use the sublist generator on the top500 page to check how many top500 systems use Nvidia accelerators. Do you see what you expected to see?
...
We hope you will enjoy your experiences as a supercomputing facility manager and share it with others!