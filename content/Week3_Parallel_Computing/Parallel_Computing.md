...
Do you think this simplified model is actually useful? Why? Remember to use the comments section.
...
Average car speed vs. density of cars (image)
...
This is quite easy to understand in general terms. When the car
...
Roads bending round into circles © iStock.com/rasslava (image)
...
Most of these models will be very boring, but with our particular choice of rules the model can be seen as a simulation of traffic moving from left to right. The traffic model is sometimes called “Rule 184” - there is a (surprisingly detailed) discussion of it on Wikipedia.
